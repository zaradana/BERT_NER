...
if __name__ == "__main__":
    ...
    args = parser.parse_args('--data_dir=data/ --bert_model=bert-base-cased --task_name=ner --output_dir=zd_out_base --max_seq_length=128 --do_train --num_train_epochs 5 --do_eval --warmup_proportion=0.1'.split())
